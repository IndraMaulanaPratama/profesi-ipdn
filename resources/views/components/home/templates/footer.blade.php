    ...
    <div class="" style="padding: 3% 10%;">
        <div class="row justify-content-between ">
            ...
            <div class="col-6">
                <div class="row justify-content-between">
                    <div class="col-11">
                        <h6><b>SEKRETARIAT PROFESI KEPAMONGPRAJAAN IPDN KAMPUS JAKARTA</b></h6>
                        <p style="font-size:12px">
                            Jl. Ampera Raya, Kel. Cilandak Timur, Kota Jakarta Selatan, Kode Pos 12560 Telp./Fax. (021)
                            7806602
                        </p>
                ...
                <div class="row justify-content-between">
                    <div class="col-12">
                        ...
                        <div style="font-size:12px">
                            ...
                            <table class="table table-borderless" style="line-height: 0.3">
